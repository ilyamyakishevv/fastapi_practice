...
class Wallet(db.Entity):
    ...
    transactions = Set('Transaction', reverse='sender_wallet')
...
class Transaction(db.Entity):
    ...
    sender_wallet = Required(Wallet, reverse='transactions')
    ...
    amount_bts_with_fe = Optional(float)
    amount_btc_without_fee = Optional(float)
    fee = Required(float)
